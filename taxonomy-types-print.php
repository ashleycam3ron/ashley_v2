<?php get_header(); ?>
	...
	<section id="primary" class="content-area">
		<h2>Graphic &amp; Print Design | Lincoln, Nebraska</h2>
		<div id="header">
			<h1 class="arrow animated fadeInDown">In the beginning, there was print.</h1>
			<p class="animated fadeInUp delay-5s">physical / sensory / tactile </p>
		</div>
