...
wp_enqueue_style('animate', get_stylesheet_directory_uri().'/css/animate.css', NULL, true);
 get_header(); ?>
	...
	<section id="primary" class="content-area">
		<h2>Website Design &amp; Development | Lincoln, Nebraska</h2>
		<div id="header">
					...
					<ul id="thumbs" class="thumbs print">
						...
						<li>
                        	<?php if (get_field('link')){ ?>
                            	<a class="link" target="_blank" href="<?php the_field('link'); ?>">
								<?php } ?>
							<a target="_blank" href="<?php  the_field('link'); //the_permalink(); ?>">
